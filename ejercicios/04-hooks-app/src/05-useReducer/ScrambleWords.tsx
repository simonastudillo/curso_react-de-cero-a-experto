...
import { getScrambleWordsInitialState, ScrambleWordsReducer } from './reducer/ScrambleWordsReducer';



export const ScrambleWords = () => {

   const [state, dispatch] = useReducer(ScrambleWordsReducer, getScrambleWordsInitialState());
   const {
      currentWord,
      errorCounter,
      guess,
