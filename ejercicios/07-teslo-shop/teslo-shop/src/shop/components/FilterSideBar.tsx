      ...
      <div className="w-64 space-y-6">
         ...
         <div className="space-y-4">
            ...
            <RadioGroup defaultValue="" className="space-y-3" value={currentPrice}>
               ...
               <div className="flex items-center space-x-2">
                  <RadioGroupItem value="0-50" id="price1" onClick={() => handlePriceChange("0-50")} />
                  <Label htmlFor="price1" className="text-sm cursor-pointer">$0 - $50</Label>
               </div>
               <div className="flex items-center space-x-2">
                  <RadioGroupItem value="50-100" id="price2" onClick={() => handlePriceChange("50-100")} />
                  <Label htmlFor="price2" className="text-sm cursor-pointer">$50 - $100</Label>
               </div>
               <div className="flex items-center space-x-2">
                  <RadioGroupItem value="100-200" id="price3" onClick={() => handlePriceChange("100-200")} />
                  <Label htmlFor="price3" className="text-sm cursor-pointer">$100 - $200</Label>
               </div>
               <div className="flex items-center space-x-2">
                  <RadioGroupItem value="200+" id="price4" onClick={() => handlePriceChange("200+")} />
